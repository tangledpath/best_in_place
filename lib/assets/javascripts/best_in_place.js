...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    ...
    if (this.formType == "select") {
      ...
      jQuery.each(this.getValues(), function(i, v) {
        if (value == v[0]) {
          var display_as = editor.element.data("display_as");
          if (display_as) {
            editor.element.html(display_as);
          } else {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.collectionUrl     = self.collectionUrl     || $parent.attr("data-collection-url");
    ...
    self.collectionUrl     = self.element.attr("data-collection-url")      || self.collectionUrl;
  ...
  bindForm : function() {
    ...
    this.getValues    = BestInPlaceEditor.forms[this.formType].getValues;
  },
  ...
  getValues : function() {
    alert("The form was not properly initialized. getValues is unbound");
  },
  ...
  loadSuccessCallback : function(data) {
    ...
    if(data && data!=""){
      ...
      if (response !== null && response.hasOwnProperty("display_as")) {
        ...
        this.element.data("display_as", response["display_as"]);
      }
...
BestInPlaceEditor.forms = {
  ...
  "select" : {
    activateForm : function() {
      ...
      jQuery.each(this.getValues(), function (index, value) {
